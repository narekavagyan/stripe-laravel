...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <img src="{{asset('img/Orange-Fruit-Pieces.jpg')}}" alt="Orange" class=" mx-auto d-block">
            <h2 class="my-4 text-center">Orange [$4]</h2>
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                ...
                                <input autocomplete='off' class='form-control card-number' size='20' type='text' maxlength="16">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ($4)</button>
                            </div>
                        </div>
                    </form>
                </div>
